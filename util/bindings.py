...
DELETE_CONNECTION = ("D", "delete_connection", "Delete")
...
CONNECTION_TREE_BINDINGS = [PREVIEW_DATA, REFRESH_CONNECTION, NEW_CONNECTION, EDIT_CONNECTION, SAVE_CONNECTIONS, DELETE_CONNECTION, TREE_LEFT, TREE_DOWN, TREE_UP, TREE_RIGHT]
